...
class Ced_CsMarketplace_Block_Vendor_Profile_Edit extends Ced_CsMarketplace_Block_Vendor_Abstract
{
    ...
    protected function _prepareForm()
    {
		...
		foreach($vendorformFields as $attribute) {
				...
				if($attribute->getAttributeCode() == "member_id"){
					$html ='<script>document.getElementById("member_id").readOnly = true;</script>';
					$element->setAfterElementHtml($html);
				}
				if($attribute->getAttributeCode() == "address"){
	...
	public function getFormUrl(){
		...
		return $this->getUrl('*/*/save',array('_secure'=>$cedsecure));
	}
