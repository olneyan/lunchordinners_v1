...
$i = 0; //counter
    						...
    						<table  border='' height='' width='650px' cellpadding='0' cellspacing='0' style='width: 95%;margin-left: 1%;'>
    							<tr>
    								...
    								<td style='width: 50%;border-top: none;text-align:right;'>
    									...
    									<span style='font-weight: bold;'>Tip:</span>"  .number_format((float)$order->getFee_amount(), 2, '.', ''). "<br/>
    ...
    margin-left: 1%;'>
           ...
           $d1 = new Datetime();
            ...
            if($vendor->getEmail() == ""){
            $username          = 'lunchordinners';  // Insert your InterFAX username here
            $password          = 'Liberty4711';
            $fax_number = '001'.$vendor->getFax();  // Insert your InterFAX password here
...
// Read data from the file into $data
           ...
           fclose($fp);
            ...
            $result->SendfaxResult; // returns the transactionID if successful        
        }
