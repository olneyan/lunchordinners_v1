 ...
 * CedCommerce
  ...
  */
class Ced_CsVAttribute_Block_Adminhtml_Vendor_Attribute_Renderer_Multifile extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    protected function _prepareToRender()
    {
        ...
        $this->addColumn('multifile', array(
