 ...
 * CedCommerce
  ...
  */
class Ced_Mobiconnect_Block_Adminhtml_Widget_Edit extends Mage_Adminhtml_Block_Widget_Form_Container {
	public function __construct() {
		parent::__construct ();
		$this->_objectId = 'id';
		$this->_blockGroup = 'mobiconnect';
		$this->_controller = 'adminhtml_widget';
		$this->_updateButton ( 'delete', 'label', Mage::helper ( 'mobiconnect' )->__ ( 'Delete' ) );
	...
	public function getHeaderText() {
		if (Mage::registry ( 'widget_data' ) && Mage::registry ( 'widget_data' )->getId ())
			return Mage::helper ( 'mobiconnect' )->__ ( "Edit Block ", $this->htmlEscape ( Mage::registry ( 'widget_data' )->getTitle () ) );
		return Mage::helper ( 'mobiconnect' )->__ ( 'Widget' );
	}
}
?>