 ...
 * CedCommerce
  ...
  */
class Ced_Mobiconnect_Block_Adminhtml_Widget_Edit_Tab_Bannergrid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    {
        return Mage::getModel('mobiconnect/widget')->load($this->getRequest()->getParam('id'));
    }
	...
	protected function _prepareColumns() {
		...
		$this->addColumn ( 'show_in', array (
				...
				'width' => '150px',
				'index' => 'show_in',
				'renderer' => 'mobiconnect/adminhtml_widget_edit_tab_renderer_website' 
		) );
