 ...
 * CedCommerce
  ...
  */
class Ced_Mobiconnect_Block_Adminhtml_Widget_Grid extends Mage_Adminhtml_Block_Widget_Grid {
	...
	protected function _prepareCollection() {
		$collection = Mage::getModel ( 'mobiconnect/widget' )->getCollection ();
	...
	protected function _prepareColumns() {
		...
		if (! Mage::app ()->isSingleStoreMode ()) {
			$this->addColumn ( 'store', array (
					'header' => Mage::helper ( 'mobiconnect' )->__ ( 'Store View' ),
					'index' => 'store',
					'type' => 'store',
					'store_all' => true,
					'store_view' => true,
		...
		$this->addColumn ( 'banner_image', array (
				'header' => Mage::helper ( 'mobiconnect' )->__ ( 'Included Images' ),
				'index' => 'banner_image',
				'align' => 'right',
				'renderer' => 'mobiconnect/adminhtml_widget_edit_tab_renderer_selectedimage' 
		)
		 );
		$this->addColumn ( 'created_at', array (
				'header' => Mage::helper ( 'mobiconnect' )->__ ( 'Created At' ),
				'index' => 'created_at',
				'align' => 'right' 
		)
		 );
		$this->addColumn ( 'updated_at', array (
				'header' => Mage::helper ( 'mobiconnect' )->__ ( 'Updated At' ),
				'index' => 'updated_at',
				'align' => 'right' 
		)
		 );
