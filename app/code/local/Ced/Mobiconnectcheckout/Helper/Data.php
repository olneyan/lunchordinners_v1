 ...
 * CedCommerce
  ...
  */
class Ced_Mobiconnectcheckout_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
        return (bool)Mage::getStoreConfig('mobiconnectcheckout/mobicheckout/activation');
    }
